...
Далее используются два скрипта: для чтения последовательного порта (получение данных датчков), публикации в /line_sensors, затем чтения оттуда и управления роботом на основе полученных данных. Ниже представлена визуализация графа ROS.

![rosgraph](./graphs/rosgraph1.png)
